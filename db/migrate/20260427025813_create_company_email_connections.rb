class CreateCompanyEmailConnections < ActiveRecord::Migration[8.0]
  def change
    create_table :company_email_connections do |t|
    ...
    add_index :company_email_connections, :company_id, unique: true
  end
end

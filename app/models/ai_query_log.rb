class AiQueryLog < ApplicationRecord
  ...
  FEATURES = %w[report_ai vision_scan ai_campaign_generate ai_campaign_refine ai_audience_generate ai_audience_refine bill_scan ai_template_generate ai_sequence_generate].freeze

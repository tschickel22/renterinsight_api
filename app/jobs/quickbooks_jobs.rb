...
class QuickbooksAutoSyncJob < ApplicationJob
  queue_as :default
...
class QuickbooksWebhookProcessorJob < ApplicationJob
  queue_as :default
...
class QuickbooksCleanupJob < ApplicationJob
  queue_as :default
...
class QuickbooksSyncHealthJob < ApplicationJob
  queue_as :default
